...
(function ($, window) {
    $.extend({
        fileDownloader: function(downloadUrl, data) {
            $.blockUI({  baseZ: 9999999, message: '<img src="/images/busy.gif" /> Please wait, preparing files for download....' });
            $.fileDownload(downloadUrl, {
                ...
                failCallback: function (html, url) {
                    $.unblockUI();
                    $("#modalMsg").html("<p>Download Failed!</p>");
                    $("#modalDialog").modal();
                },
                httpMethod: "POST",
                data: data
